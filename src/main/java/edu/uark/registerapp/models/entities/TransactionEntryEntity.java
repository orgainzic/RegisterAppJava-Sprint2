...
public class TransactionEntryEntity {
    ...
    public TransactionEntry synchronize(final TransactionEntry apiTransactionEntry) {
        ...
        apiTransactionEntry.setPrice(this.getPrice());
        apiTransactionEntry.setId(this.getId());
        apiTransactionEntry.setProductId(this.getProductId());
        apiTransactionEntry.setTransactionId(this.getTransactionId());
